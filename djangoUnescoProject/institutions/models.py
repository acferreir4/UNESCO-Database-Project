...
class Institution(models.Model):
    ...
    type_of_inst = models.CharField('Type', max_length=50)
    ...
    online = models.CharField(
            'Use of online learning material', 
            max_length=50, 
            null=True, 
            blank=True
            )
    ...
    further = models.CharField('Further levels of education', max_length=50, null=True, blank=True)
