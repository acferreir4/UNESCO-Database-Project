...
{\reportQuestionName~\thesection} % Format of the section label
...
% Environment to be used for each question in the report
\newenvironment{question}{
	\vspace{0.5\baselineskip} % Whitespace before the question
	\section{} % Blank section title (e.g. just Question 2)
	\lfoot{\small\itshape\reportQuestionName~\thesection~continued on next page\ldots} % Set the left footer to state the question continues on the next page, this is reset to nothing if it doesn't (below)
}{
...
% Command to print an report section title to split an report into major parts
\newcommand{\reportSection}[1]{
	{
		\centering % Center the section title
